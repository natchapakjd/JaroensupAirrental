...
const EditTechProfile = () => {
  ...
  const [language, setLanguage] = useState(localStorage.getItem('language'||'th')); // Default language is English
  ...
  return (
    ...
    <h1 className="text-xl font-bold mb-4">{translations[language].editTechProfile}</h1>
    <form onSubmit={handleSubmit}>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        {/* Nationality */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].nationality}</label>
          <input
            type="text"
            name="nationality"
        ...
        {/* Work Experience */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].workExperience}</label>
          <input
            type="text"
        ...
        {/* Special Skills */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].specialSkills}</label>
          <input
            type="text"
            name="special_skills"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].backgroundCheckStatus}</label>
          <input
            type="text"
        ...
        {/* Bank Account Number */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].bankAccountNumber}</label>
          <input
            type="text"
        ...
        {/* Start Date */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].startDate}</label>
          <input
            type="date"
            name="start_date"
        ...
        {/* Status */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].status}</label>
          <select
            name="status_id"
        ...
        {/* ID Card Image URL */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].idCardImageUrl}</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].driverLicenseImageUrl}</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].criminalRecordImageUrl}</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].additionalImageUrl}</label>
          <input
            type="text"
        ...
        {/* Is Outsource */}
        <div className="mb-4">
          <label className="block text-sm font-medium">{translations[language].isOutsource}</label>
          <input
            type="checkbox"
            name="isOutsource"
