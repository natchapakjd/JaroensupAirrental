...
const AddUser = () => {
  ...
  return (
    <div className="mx-auto p-6 bg-white rounded-lg shadow-md h-screen">
      <h1 className="text-2xl font-bold mb-4">{translations[language].addUser}</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          ...
          {/* First Name */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].firstname}:</label>
            <input
              type="text"
              name="firstname"
          ...
          {/* Last Name */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].lastname}:</label>
            <input
              type="text"
              name="lastname"
          ...
          {/* Age */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].age}:</label>
            <input
              type="number"
              name="age"
              value={formData.age}
          ...
          {/* Gender */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].gender}:</label>
            <select
              name="gender_id"
          ...
          {/* Date of Birth */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].date_of_birth}:</label>
            <input
              type="date"
              name="date_of_birth"
          ...
          {/* Role */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].role}:</label>
            <select
              name="role_id"
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium text-gray-700">{translations[language].address}:</label>
            <textarea
              name="address"
          ...
          {/* Profile Image */}
          <div>
            <label className="block text-sm font-medium text-gray-700">{translations[language].profile_image}:</label>
            <input
              type="file"
              name="profile_image"
