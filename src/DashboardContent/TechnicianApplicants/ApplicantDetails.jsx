    ...
    <div className="p-8 rounded-lg shadow-lg w-full mx-auto font-inter h-full bg-base-200">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <ul className="list-disc list-inside">
          <li>
            <strong>ชื่อ:</strong> {applicant.first_name} {applicant.last_name}
          </li>
          <li>
            <strong>วันเกิด:</strong>{" "}
            {new Date(applicant.date_of_birth).toLocaleDateString("th-TH")}
          </li>
          <li>
            <strong>อีเมล:</strong> {applicant.email}
          </li>
          <li>
            <strong>ตำแหน่งที่สมัคร:</strong> {applicant.position_applied}
          </li>
          <li>
            <strong>สถานะ:</strong> {applicant.status_name}
          </li>
          <li>
            <strong>วันที่สมัคร:</strong>{" "}
            {new Date(applicant.application_date).toLocaleDateString("th-TH")}
          </li>
          <li>
            <strong>หมายเหตุ:</strong> {applicant.notes || "ไม่มีหมายเหตุ"}
          </li>
        </ul>
      </div>
