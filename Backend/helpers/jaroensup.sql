...
(1, 6, 26, '500.00', '2024-09-20 20:00:00', NULL, 5, NULL, 1, '2024-09-30 18:49:37');
...
(3, 'น้ำยาถังแอร์', 'น้ำยาถังแอร์', '555.00', 6, 1, 1, 1, 1, 'https://res.cloudinary.com/dq8euhi61/image/upload/v1727333157/image/product-image/qzggzwnxchcfrmt4pmqw.jpg'),
(7, 'พัดลมไอน้ำ', 'พัดลมไอน้ำ', '500.00', 2, 1, 3, 1, 1, 'https://res.cloudinary.com/dq8euhi61/image/upload/v1728394918/image/product-image/ptozqgegyub8qfis5aom.jpg'),
(10, 'asdasd', 'asdasd', '5.00', 2, 1, 2, 1, 1, 'https://res.cloudinary.com/dq8euhi61/image/upload/v1727544639/image/product-image/qi9282ozqb736mpn0v1i.jpg');
...
(5, 12, 6, 1, 5, 'ฟหก', '2024-09-26 07:37:21');
...
(26, 6, 'งานเช่าพัดลมไอน้ำ', '2024-09-22 16:35:29', NULL, NULL, 1, NULL, 'กรุงเทพ พหลโยธิน', '2024-09-19 23:35:00', '13.80674218', '100.50052643', 1, '2024-10-08 13:13:48', 1);
...
(9, 'ขายเครื่องปรับอากาศ', 'ขายเครื่องปรับอากาศ'),
...
(1, '2003-09-03', 'กทม', 'natchapakjd@gmail.com', '0641160893', '2024-09-23 06:11:35', 'ช่างซ่อมบำรุง', 'โน้ตเพิ่มเติม', '2024-09-25', 'admin', 'ช่าง', 'ในระบบ', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `users` (`user_id`, `username`, `password`, `firstname`, `lastname`, `email`, `phone`, `age`, `address`, `gender`, `created_at`, `linetoken`, `date_of_birth`, `image_url`, `role_id`) VALUES
(2, 'admin', '$2b$10$ThT9xSLUiZ4ZwAYZshVf6ulBktjc6tImodfFr8Uf9IME1SDI.Q.XW', 'firstname', 'lastname', 'admin@gmail.com', '0641159783', 5, 'กทม', 'female', '2024-09-11 12:32:23', NULL, '2024-09-19', 'https://res.cloudinary.com/dq8euhi61/image/upload/v1727462309/image/user-image/czf9574soadtxq378hjz.jpg', 3),
(3, 'tech', '$2b$10$ltJ786G/tiUyM/bIJ1z/LeSyAqzCstfaGZsTNipj.1X0n3yZPd/S6', 'ช่าง', 'ในระบบ', 'tech@gmail.com', '0641159783', 7, 'กทม', 'female', '2024-09-12 07:18:25', NULL, '2024-09-17', NULL, 2),
(6, 'member', '$2b$10$FaSFGRxhPP0dH2IYi9D5kOhiBz0He.to1V8UQQYMVqE8K0aQT4rue', 'ลูกค้า', 'ในระบบ', 'asdasdas@gmailcom', '0641159783', 25, 'กทม', 'male', '2024-09-13 11:58:33', 'U9cb564155dddeaa549d97a8747eed534', '2024-09-19', 'https://res.cloudinary.com/dq8euhi61/image/upload/v1727331372/image/user-image/b3gsanuh4utc3dvgnxoj.jpg', 1);
